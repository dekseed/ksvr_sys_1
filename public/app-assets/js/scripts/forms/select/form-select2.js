...
(function(window, document, $) {
  ...
  // Basic Select2 select
    ...
    var data = [
        { id: 'นาย', text: 'นาย' },
        { id: 'นาง', text: 'นาง' },
        { id: 'นางสาว', text: 'นางสาว' },
        { id: 'พันเอก', text: 'พันเอก' },
        {
            id: 'พันเอกหญิง',
            text: 'พันเอกหญิง'
        },
        ...
        { id: 'พันตรี', text: 'พันตรี' },
        {
            id: 'พันตรีหญิง',
            text: 'พันตรีหญิง'
        },
        { id: 'ร้อยเอก', text: 'ร้อยเอก' },
        {
            id: 'ร้อยเอกหญิง',
            text: 'ร้อยเอกหญิง'
        },
        { id: 'ร้อยโท', text: 'ร้อยโท' },
        {
            id: 'ร้อยโทหญิง',
            text: 'ร้อยโทหญิง'
        },
        { id: 'ร้อยตรี', text: 'ร้อยตรี' },
        {
            id: 'ร้อยตรีหญิง',
            text: 'ร้อยตรีหญิง'
        },
        { id: 'จ่าสิบเอก', text: 'จ่าสิบเอก' },
        {
            id: 'จ่าสิบเอกหญิง',
            text: 'จ่าสิบเอกหญิง'
        },
        { id: 'จ่าสิบโท', text: 'จ่าสิบโท' },
        {
            id: 'จ่าสิบโทหญิง',
            text: 'จ่าสิบโทหญิง'
        },
        { id: 'จ่าสิบตรี', text: 'จ่าสิบตรี' },
        {
            id: 'จ่าสิบตรีหญิง',
            text: 'จ่าสิบตรีหญิง'
        },
        { id: 'สิบเอก', text: 'สิบเอก' },
        {
            id: 'สิบเอกหญิง',
            text: 'สิบเอกหญิง'
        },
    ...
    var position = [
        { id: 'แพทย์', text: 'แพทย์' },
        { id: 'พยาบาล', text: 'พยาบาล' },
        { id: 'ผู้ช่วยพยาบาล', text: 'ผู้ช่วยพยาบาล' },
        { id: 'นายสิบพยาบาล', text: 'นายสิบพยาบาล' },
        { id: 'เภสัชกร', text: 'เภสัชกร' },
        { id: 'ทันตแพทย์', text: 'ทันตแพทย์' },
        { id: 'ลูกจ้างประจำ', text: 'ลูกจ้างประจำ' },
        { id: 'ลูกจ้างชั่วคราว', text: 'ลูกจ้างชั่วคราว' },
        { id: 'พนักงานราชการ', text: 'พนักงานราชการ' },
    ...
    var data = [
        ...
        { id: '4', text: 'ซักรีด' },
        { id: '5', text: 'ทะเบียน' },
        { id: '6', text: 'หอผู้ป่วยนอก' },
        { id: '7', text: 'ศูนย์ผู้ป่วยใน' },
        { id: '8', text: 'เภสัชกรรม' },
        { id: '9', text: 'หอผู้ป่วยใน' },
        { id: '10', text: 'ศูนย์คอมพิวเตอร์' },
        { id: '11', text: 'องค์พยาบาล' },
        { id: '12', text: 'ห้องผ่าตัด' },
        { id: '13', text: 'กายภาพบำบัด' },
        { id: '14', text: 'ฝังเข็ม' },
        { id: '15', text: 'แพทย์แผนไทย (นวด)' },
        { id: '16', text: 'สปา' },
        { id: '17', text: 'LAB' },
        { id: '18', text: 'จ่ายกลาง' },
        { id: '19', text: 'สูทกรรม' },
        { id: '20', text: 'ซักรีด' },
        { id: '21', text: 'ศูนย์เด็กเล็กฯ' },
        { id: '22', text: 'ศูนย์ส่งเสริมสุขภาพฯ' },
        { id: '23', text: 'ส่งกำลังและบริการ' },
        { id: '24', text: 'หมวดพลเสนารักษ์' },
        { id: '25', text: 'ธุรการ' },
        { id: '26', text: 'การเงิน' },
        { id: '27', text: 'พลาธิการ' },
        { id: '28', text: 'จุดคัดกรองฯ' },
        {
            id: '29',
            text: 'ยุทธโยธา'
        },
    ...
    // หมู่เลือด
    var data2 = [
        { id: 'หมู่เอ (A)', text: 'หมู่เอ (A)' },
        { id: 'หมู่บี (B)', text: 'หมู่บี (B)' },
        { id: 'หมู่โอ (O)', text: 'หมู่โอ (O)' },
        { id: 'หมู่เอบี (AB)', text: 'หมู่เอบี (AB)' },
    ];
    ...
    var amphoes = [
        ...
        { id: '1', text: 'อำเภอเมือง' },
        { id: '2', text: 'กุสุมาลย์' },
        { id: '3', text: 'กุดบาก' },
        { id: '4', text: 'พรรณานิคม' },
        { id: '5', text: 'พังโคน' },
        { id: '6', text: 'วาริชภูมิ' },
        { id: '7', text: 'นิคมน้ำอูน' },
        { id: '8', text: 'วานรนิวาส' },
        { id: '9', text: 'คำตากล้า' },
        { id: '10', text: 'บ้านม่วง' },
        { id: '11', text: 'อากาศอำนวย' },
        { id: '12', text: 'สว่างแดนดิน' },
        { id: '13', text: 'ส่องดาว' },
        { id: '14', text: 'เต่างอย' },
        { id: '15', text: 'โคกศรีสุพรรณ' },
        { id: '16', text: 'เจริญศิลป์' },
        { id: '17', text: 'โพนนาแก้ว' },
        { id: '18', text: 'ภูพาน' },
