    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($item->report_check_up_cbc->blood_wbc >= '4.5' && $item->report_check_up_cbc->blood_wbc  <= '10.6') @else is-invalid @endif"
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($item->report_check_up_cbc->blood_rbc >= '4.5' && $item->report_check_up_cbc->blood_rbc  <= '6.0') @else is-invalid @endif"
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($item->report_check_up_cbc->blood_hb >= '13' && $item->report_check_up_cbc->blood_hb  <= '18') @else is-invalid @endif"
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($item->report_check_up_cbc->blood_hct >= '40.0' && $item->report_check_up_cbc->blood_hct  <= '51.0') @else is-invalid @endif"
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($item->report_check_up_cbc->blood_mcv >= '80' && $item->report_check_up_cbc->blood_mcv  <= '94.5') @else is-invalid @endif"
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($item->report_check_up_cbc->blood_plt >= '138' && $item->report_check_up_cbc->blood_plt  <= '391') @else is-invalid @endif"
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($item->report_check_up_cbc->blood_ne >= '39.6' && $item->report_check_up_cbc->blood_ne  <= '71.6') @else is-invalid @endif"
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($item->report_check_up_cbc->blood_ly >= '18.3' && $item->report_check_up_cbc->blood_ly  <= '49') @else is-invalid @endif"
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($item->report_check_up_cbc->blood_mo >= '2.3' && $item->report_check_up_cbc->blood_mo  <= '8.7') @else is-invalid @endif"
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($item->report_check_up_cbc->blood_eo >= '0' && $item->report_check_up_cbc->blood_eo  <= '7.8') @else is-invalid @endif"
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($item->report_check_up_cbc->blood_ba >= '0' && $item->report_check_up_cbc->blood_ba  <= '1.8') @else is-invalid @endif"
