...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($lab_order_rbc == 'Negative') @else is-invalid @endif"
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($lab_order_wbc == 'Negative') @else is-invalid @endif"
...
@endif
@if($roles->lab_items_name_ref == 'EPITHERIAL')
<div class="col-md-12">
    <div class="form-group row">
