        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <section id="number-tabs">
                    <div class="row">
                        <div class="col-12">
                            <h1 class="card-title text-center">ลงข้อมูลตรวจสุขภาพ</h1>
                            <div class="card">
                                        ...
                                        @endif
                                            <div class="card">
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <div class="form-body">
                                                            <h4 class="form-section"><i class="feather icon-save"></i> ข้อมูลตรวจสุขภาพปี</h4>
                                                            <div class="row">
                                                                <div class="col-md-9">
                                                                ...
                                                                <div class="col-md-4 col-12 mb-1">
                                                                    ...
                                                                    <fieldset>
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="number" class="form-control" placeholder="ชีพจร" aria-label="ชีพจร"
                                                        ...
                                                        <div class="form-body">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    @include('pages.check_up.v_2.admin.unit_army.include.create_1.create_import_cbc')
                                                        ...
                                                        <div class="form-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    @include('pages.check_up.v_2.admin.unit_army.include.create_1.create_import_BloodChemistry')
                                                        ...
                                                        <div class="form-body">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    @include('pages.check_up.v_2.admin.unit_army.include.create_1.create_import_urine')
