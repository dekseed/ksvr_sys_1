                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-data"><a href="{{ route('home') }}">หน้าหลัก</a>
                                    </li>
                                    <li class="breadcrumb-data"><a href="{{ route('check_up.index') }}">KSVR Check Up</a>
                                    </li>
                                    <li class="breadcrumb-data"><a href="{{ route('check_up.index') }}">หน่วยงานทหาร</a>
                                    </li>
                                    <li class="breadcrumb-data active"><i class="feather icon-clipboard"></i> ข้อมูลตรวจสุขภาพปี {{ $data->year }}
                                    </li>
                                </ol>
                            </div>
                        </div>
                                                                                    ...
                                                                                    <li class="d-inline-block mr-2">
                                                                                        <fieldset>
                                                                                            <div class="vs-radio-con">
                                                                                                ...
                                                                                                @if($data->report->m13_1 ==  "0") checked="checked" @endif disabled="disabled">
                                                                                                <span class="vs-radio">
                                                                                    ...
                                                                                    <li class="d-inline-block mr-2">
                                                                                        <fieldset>
                                                                                            <div class="vs-radio-con">
                                                                                                ...
                                                                                                @if($data->report->m13_1 ==  "1") checked="checked" @endif disabled="disabled">
                                                                                                <span class="vs-radio">
                                                                                                    <span class="vs-radio--border"></span>
                                                                                                    <span class="vs-radio--circle"></span>
                                                                                                </span>
                                                                                    ...
                                                                                    <li class="d-inline-block mr-2">
                                                                                        <fieldset>
                                                                                            <div class="vs-radio-con">
                                                                                                ...
                                                                                                @if($data->report->m13_1 ==  "2") checked="checked" @endif disabled="disabled">
                                                                                                <span class="vs-radio">
                                                                                                    <span class="vs-radio--border"></span>
                                                                                                    <span class="vs-radio--circle"></span>
                                                                                                </span>
                                                                                    ...
                                                                                    <li class="d-inline-block">
                                                                                        <fieldset>
                                                                                            <div class="vs-radio-con">
                                                                                                ...
                                                                                                @if($data->report->m13_1 ==  "3") checked="checked" @endif disabled="disabled">
                                                                                                <span class="vs-radio">
                                                                                                    <span class="vs-radio--border"></span>
                                                                                                    <span class="vs-radio--circle"></span>
                                                                                                </span>
                                                                                    ...
                                                                                    <li class="d-inline-block mr-2">
                                                                                        <fieldset>
                                                                                            <div class="vs-radio-con">
                                                                                                ...
                                                                                                @if($data->report->m13_2 ==  "0") checked="checked" @endif disabled="disabled">
                                                                                                <span class="vs-radio">
                                                                                                    <span class="vs-radio--border"></span>
                                                                                                    <span class="vs-radio--circle"></span>
                                                                                                </span>
                                                                                    ...
                                                                                    <li class="d-inline-block mr-2">
                                                                                        <fieldset>
                                                                                            <div class="vs-radio-con">
                                                                                                ...
                                                                                                @if($data->report->m13_2 ==  "1") checked="checked" @endif disabled="disabled">
                                                                                                <span class="vs-radio">
                                                                                                    <span class="vs-radio--border"></span>
                                                                                                    <span class="vs-radio--circle"></span>
                                                                                                </span>
                                                                                    ...
                                                                                    <li class="d-inline-block mr-2">
                                                                                        <fieldset>
                                                                                            <div class="vs-radio-con">
                                                                                                ...
                                                                                                @if($data->report->m13_2 ==  "2") checked="checked" @endif disabled="disabled">
                                                                                                <span class="vs-radio">
                                                                                                    <span class="vs-radio--border"></span>
                                                                                                    <span class="vs-radio--circle"></span>
                                                                                                </span>
                                                                                    ...
                                                                                    <li class="d-inline-block">
                                                                                        <fieldset>
                                                                                            <div class="vs-radio-con">
                                                                                                ...
                                                                                                @if($data->report->m13_2 ==  "3") checked="checked" @endif disabled="disabled">
                                                                                                <span class="vs-radio">
                                                                                                    <span class="vs-radio--border"></span>
                                                                                                    <span class="vs-radio--circle"></span>
                                                                                                </span>
                                                                                    ...
                                                                                    <li class="d-inline-block mr-2">
                                                                                        <fieldset>
                                                                                            <div class="vs-radio-con">
                                                                                                ...
                                                                                                @if($data->report->m13_3 ==  "0") checked="checked" @endif disabled="disabled">
                                                                                                <span class="vs-radio">
                                                                                                    <span class="vs-radio--border"></span>
                                                                                                    <span class="vs-radio--circle"></span>
                                                                                                </span>
                                                                                    ...
                                                                                    <li class="d-inline-block mr-2">
                                                                                        <fieldset>
                                                                                            <div class="vs-radio-con">
                                                                                                ...
                                                                                                @if($data->report->m13_3 ==  "1") checked="checked" @endif disabled="disabled">
                                                                                                <span class="vs-radio">
                                                                                                    <span class="vs-radio--border"></span>
                                                                                                    <span class="vs-radio--circle"></span>
                                                                                                </span>
                                                                                    ...
                                                                                    <li class="d-inline-block mr-2">
                                                                                        <fieldset>
                                                                                            <div class="vs-radio-con">
                                                                                                ...
                                                                                                @if($data->report->m13_3 ==  "2") checked="checked" @endif disabled="disabled">
                                                                                                <span class="vs-radio">
                                                                                                    <span class="vs-radio--border"></span>
                                                                                                    <span class="vs-radio--circle"></span>
                                                                                                </span>
