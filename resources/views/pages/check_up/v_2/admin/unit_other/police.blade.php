                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    {{-- <h4 class="card-title text-center">หน่วยงานตำรวจ</h4> --}}
                                </div>
                                <div class="card-content">
                                    <h2 class="text-center">หน่วยงานตำรวจ</h2>
                                    ...
                                    <div class="card-body card-dashboard">
                                        ...
                                        <div class="text-right"><a href="{{ route('police.create')}}" class="btn btn-primary  waves-effect waves-light"><i class="feather feather icon-plus"></i> เพิ่มข้อมูล</a></div>
                                        <div class="table-responsive">
                                            <table id="army" class="table zero-configuration">
                                                <thead>
                                                    <tr>
