                ...
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title text-center"><i class="feather icon-save"></i> ข้อมูลตรวจสุขภาพ</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        @if(count($data2))
                                            ...
                                            <div role="tabpanel" class="tab-pane" id="home{{$item->year}}-fill" aria-labelledby="home{{$item->year}}-tab-fill" aria-expanded="true">
                                                ...
                                                <div class="container">
                                                    ...
                                                    <h2 class="text-center mb-2 mt-2"><i class="feather icon-clipboard"></i> ข้อมูลตรวจสุขภาพประจำปี {{$item->year}}</h2>
                                                    
                                                    <div class="form-body">       
                                                        <div class="row">
                                                            <div class="col-md-3 col-12 mb-1">
                                                                <label for="projectinput3">น้ำหนัก{{$item->year}}</label>
                                                                <fieldset>
