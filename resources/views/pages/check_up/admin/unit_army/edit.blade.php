                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <form id="store" class="form-horizontal" name="store" action="{{ route('army.update', $data->id)}}" method="POST">
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}    
                                        <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class=" position-relative has-icon-left">
                                                            <input type="text" id="age" class="form-control" value="{{ $data->age }}" name="age" >
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-user"></i>
                                                                </div>
                                                            ...
                                                            <div class="position-relative has-icon-left">
                                                                <div class="form-group">
                                                                    <select class="form-control" id="basicSelect" name="gender">
                                                                        <option {{ $data->title_name == 'ชาย' ? 'selected' : '' }} value="ชาย">ชาย</option>
                                                                        <option {{ $data->title_name == 'หญิง' ? 'selected' : '' }} value="หญิง">หญิง</option>
                                                                    </select>
                                                                    <div class="form-control-position">
                                                                        <i class="feather icon-user"></i>
                                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class=" position-relative">
                                                                <input class="form-control" id="testdate5" name="birthdate" value="{{ $data->birthdate }}"> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                                                ...
                                                                                <fieldset>
                                                                                    <div class="input-group">
                                                                                        ...
                                                                                        <input type="text" class="form-control" aria-label="" placeholder=""
                                                                                                                name="class_d" id='class_d' value="{{ $data->class }}">
                                                                                    </div>
                                                                                </fieldset>
                                            ...
                                            <div class="modal-footer">
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <a class="btn btn-danger mr-1 mb-1 waves-effect waves-light" href="{{ route('army.show', $data->id)}}"><i class="fa fa-times"></i> ยกเลิก</a>
