                                        ...
                                        <div class="col-12 col-md-12 col-lg-5">
                                            <table class="ml-0 ml-sm-0 ml-lg-0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $userPol->check_up_user_pol->kind_check_up->name }}</td>
                                                </tr>
                                            </table>
                                        </div>
                                        <div class="col-12 text-right">
                                            <a href="{{ route('police.editpro', $userPol->user_pols_id)}}" class="btn btn-primary mr-1  waves-effect waves-light"><i class="feather icon-edit-1"></i> แก้ไขข้อมูลส่วนตัว</a>
                                            <a href="{{ route('police.edit', $userPol->id)}}" class="btn btn-info mr-1  waves-effect waves-light"><i class="feather icon-edit-1"></i> แก้ไขข้อมูลตรวจสุขภาพ</a>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        <form action="{{ route('police.destroy', $userPol->id)}}" method="post">
                                                            {{ method_field('delete') }}
                                                             {{ csrf_field() }}
                                                            <button type="submit"class="btn btn-primary mr-1 waves-effect waves-light mt-1"><i class="feather icon-trash-2"></i> ลบข้อมูลตรวจสุขภาพประจำปี</button>
                                                        </form>
                                                        
                                                        <form action="{{ route('user_police.destroy', $userPol->id)}}" method="post">
                                                            {{ method_field('delete') }}
                                                             {{ csrf_field() }}
                                                            <button type="submit" class="btn btn-danger mr-1 waves-effect waves-light mt-1"><i class="feather icon-trash-2"></i> ลบข้อมูลทั้งหมด</button>
                                                        </form>
                                ...
                                <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text" id="BP_S" class="form-control" name="BP_S" placeholder="BP_S" value="{{ $userPol->BP_S }}" disabled>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="position-relative has-icon-left">
                                                            <input type="text" id="BP_D" class="form-control" name="BP_D" placeholder="BP_D" value="{{ $userPol->BP_D }}" disabled>
                                                            <div class="form-control-position">
                                                                <i class="feather icon-user"></i>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="eventName3">
                                                            ...
                                                            <div class="position-relative has-icon-left">
                                                                <input type="text" id="Pulse" class="form-control" name="Pulse" placeholder="Pulse" value="{{ $userPol->PULSE }}" disabled>
                                                                    <div class="form-control-position">
                                                                        <i class="feather icon-user"></i>
                                                                    </div>
                                                                </div>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="Weight" class="form-control" name="Weight" placeholder="Weight" value="{{ $userPol->Weight }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="Height" class="form-control" name="Height" placeholder="Height" value="{{ $userPol->Height }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="BML" class="form-control" name="BML" placeholder="BML" value="{{ $userPol->BML }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="WAIST" class="form-control" name="WAIST" placeholder="WAIST" value="{{ $userPol->WAIST }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                ...
                                <div class="card-body">
                                    <table class="">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="WBC" class="form-control" name="WBC" placeholder="WBC" value="{{ $userPol->WBC }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="RBC" class="form-control" name="RBC" placeholder="RBC" value="{{ $userPol->RBC }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="Hb" class="form-control" name="Hb" placeholder="Hb" value="{{ $userPol->Hb }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="Hct" class="form-control" name="Hct" placeholder="Hct" value="{{ $userPol->Hct }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="MCV" class="form-control" name="MCV" placeholder="MCV" value="{{ $userPol->MCV }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="NE" class="form-control" name="NE" placeholder="NE" value="{{ $userPol->NE }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="LY" class="form-control" name="LY" placeholder="LY" value="{{ $userPol->LY }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="MO" class="form-control" name="MO" placeholder="MO" value="{{ $userPol->MO }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="EO" class="form-control" name="EO" placeholder="EO" value="{{ $userPol->EO }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="BA" class="form-control" name="BA" placeholder="BA" value="{{ $userPol->BA }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                ...
                                <div class="card-body">
                                    <table class="">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="UBlood" class="form-control" name="UBlood" placeholder="UBlood" value="{{ $userPol->UBlood }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="ketone" class="form-control" name="ketone" placeholder="ketone" value="{{ $userPol->ketone }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="Uglu" class="form-control" name="Uglu" placeholder="Uglu" value="{{ $userPol->Uglu }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="Upro" class="form-control" name="Upro" placeholder="Upro" value="{{ $userPol->Upro }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="URBC" class="form-control" name="URBC" placeholder="URBC" value="{{ $userPol->URBC }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="UWBC" class="form-control" name="UWBC" placeholder="UWBC" value="{{ $userPol->UWBC }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="UEPI" class="form-control" name="UEPI" placeholder="UEPI" value="{{ $userPol->UEPI }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                ...
                                <div class="card-body">
                                    <table class="">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="StoolWBC" class="form-control" name="StoolWBC" placeholder="StoolWBC" value="{{ $userPol->StoolWBC }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="StoolRBC" class="form-control" name="StoolRBC" placeholder="StoolRBC" value="{{ $userPol->StoolRBC }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="Ova" class="form-control" name="Ova" placeholder="Ova&Parasite" value="{{ $userPol->Ova }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="Occult" class="form-control" name="Occult" placeholder="Occult Blood" value="{{ $userPol->Occult }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                ...
                                <div class="card-body">
                                    <table class="">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="FBS" class="form-control" name="FBS" placeholder="FBS" value="{{ $userPol->FBS }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="BUN" class="form-control" name="BUN" placeholder="BUN" value="{{ $userPol->BUN }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="Cre" class="form-control" name="Cre" placeholder="Cre" value="{{ $userPol->Cre }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="Cric" class="form-control" name="Cric" placeholder="Cric" value="{{ $userPol->Cric }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="Chol" class="form-control" name="Chol" placeholder="Chol" value="{{ $userPol->Chol }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="Tg" class="form-control" name="Tg" placeholder="Tg" value="{{ $userPol->Tg }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="HDL" class="form-control" name="HDL" placeholder="HDL" value="{{ $userPol->HDL }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="LDL" class="form-control" name="LDL" placeholder="LDL" value="{{ $userPol->LDL }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="ALK" class="form-control" name="ALK" placeholder="ALK" value="{{ $userPol->ALK }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="SGOT" class="form-control" name="SGOT" placeholder="SGOT" value="{{ $userPol->SGOT }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="SGPT" class="form-control" name="SGPT" placeholder="SGPT" value="{{ $userPol->SGPT }}" disabled>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <h6 class="border-bottom py-1 mx-1 mb-1 font-medium-2"><i class="feather icon-repeat mr-50 "></i> ประวัติการตรวจรักษา</h6>
                                                        <div class="row">
                                                            <div class="col-md-12 mb-1">
                                                                ...
                                                                @if($userPol->medical_history ==  "อื่นๆ")
                                                                    <div class="form-group mt-1">
                                                                        <div class="position-relative has-icon-left">
                                                                        <input type="text" id="fname-icon" class="form-control" name="medical_history_other" value="{{ $userPol->medical_history_other }}" disabled>
                                                                            <div class="form-control-position">
                                                                                <i class="feather icon-user"></i>
                                                                            </div>
                                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="table-responsive border rounded px-1 mt-1 mb-1">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 mb-1">
                                                            {{ $userPol->congenital_disease }} @if(!empty($userPol->congenital_disease_detail)) ({{$userPol->congenital_disease_detail}})  @endif
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="table-responsive border rounded px-1 mt-1 mb-1">
