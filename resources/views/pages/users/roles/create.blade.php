                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <div class="position-relative has-icon-left">
                                                                        <input type="text" class="form-control" value="{{ old('display_name') }}" name="display_name" placeholder="ชื่อ (Display Name)" required data-validation-required-message="This username field is required">
