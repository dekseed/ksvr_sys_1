                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">แก้ไขรายการ</h4>
                                </div>
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        ...
                                                        <div class="form-label-group">
                                                            <input type="text" class="form-control" id="model" name="model" placeholder="a123 .." value="{{$stocks->name}}" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-12">
                                                        <label for="sn">S/N</label>
                                                        <div class="form-label-group">
                                                            <input type="text" class="form-control" id="sn" name="sn" placeholder="123abc.." value="{{$stocks->name}}" required>
                                                        </div>
                                                    </div>
                                                     <div class="col-md-6 col-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-9 col-12">
                                                                    <select id="projectinput6" name="expenditure" class="form-control" required>
                                                                         <?php $lists = ['งบรายรับสถานพยาบาล', 'งบค่าเสื่อม', 'งบบริจาค']; ?>
                                                     ...
                                                     <div class="col-md-6 col-12">
                                                        ...
                                                        <div class="form-label-group">
                                                             <select class="form-control select2" name="user_kinds" id="data-status">
                                                                ...
                                                                <option value="{{$roles->id}}" {{ $roles->id == $stocks->stock_kinds_id ? 'selected' : '' }}>{{$roles->title_name->name}}{{$roles->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 text-right">
                                                        <button type="submit" class="btn btn-primary mr-1 mt-1" >แก้ไขรายการ</button>
                                                        <button type="reset" class="btn btn-outline-warning mr-1 mt-1" onclick="goBack()">ยกเลิก</button>
                                                    </div>
