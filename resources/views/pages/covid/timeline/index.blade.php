                    ...
                    <div class="todo-app-menu">
                        ...
                        <div class="sidebar-menu-list">
                            <div class="list-group list-group-filters font-medium-1">
                                ...
                                @if ($loop->first)
                                    <a href="{{route('timeline-covid.show', $items->date)}}" class="list-group-item list-group-item-action border-0 pt-0 active">
                                @else
                                    <a href="{{route('timeline-covid.show', $items->date)}}" class="list-group-item list-group-item-action border-0 pt-0">
                                @endif
                                    <i class="font-medium-5 feather icon-star"></i> วันที่ {{DateFThai(date('d-m-Y', strtotime($items->date)))}}
                                </a>
                            ...
                            <div class="todo-app-list">
                                ...
                                <div class="todo-task-list list-group">
                                    <ul class="todo-task-list-wrapper media-list">
                                        @foreach ($timeline_detail_first as $day => $users_list)
                                        @if ($loop->first)
                                                ...
                                                <div class="todo-title-wrapper d-flex justify-content-between mb-50">
                                                    <div class="todo-title-area d-flex align-items-center">
                                                        ...
                                                        <div class="chip-wrapper">
                                                            ...
                                                            <div class="chip mb-0">
                                                                <div class="chip-body">
                                                                    <span class="chip-text" data-value="Frontend"><span class="bullet bullet-muted bullet-xs"></span> ตรวจหาโควิด-19 (T2) |
