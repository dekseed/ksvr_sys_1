...
<fieldset>
    ...
    <div class="form-group ">
        <label style="color:mediumseagreen;font-weight:700;font-size:18px"><i
                class="fa fa-folder-open-o"></i> การได้รับวัคซีน </label>
    </div>
    <div class="form-group">
        <div class="position-relative has-icon-left">
            <select class="form-control" id="basicSelect" name="vac_id" onchange="showDiv2(this)" required>
        ...
        <div id="hidden_div1" class="mt-1" style="display:none;">
            ...
            <div class="position-relative has-icon-left">
                <select class="form-control" id="basicSelect" name="num_vac"
                    onchange="showDiv1p(this), showDiv2p(this), showDiv3p(this), showDiv4p(this)">
                ...
                <div class="col-12">
                    <div class="card border-success p-1">
                        <h2 style="color:rgb(53, 141, 141);font-size:16px" class="text-center mb-2"><i
                                class="feather icon-clipboard"></i> รายละเอียดวัคซีนเข็มที่ 1</h2>
                        <div class="form-group">
                            <div class="form-body">
                                <div class="col-12">
                                    <div class="form-body">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="position-relative has-icon-left">
                                                            <select class="form-control select2-l-1"
                                                                name="name_vaccine_id_1" id="basicSelect">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="position-relative has-icon-left">
                                                            <input type="date"
                                                                class="form-control pickadate picker__input" readonly=""
                                                                id="P428173107" aria-haspopup="true"
                                                                aria-readonly="false" aria-owns="P428173107_root"
                                                                placeholder="วันที่ได้รับวัคซีน" name="date_1">
                                                            <div class="form-control-position">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="position-relative has-icon-left">
                                                            <input type="text" id="Vaccine" class="form-control"
                                                                name="location_1" placeholder="สถานที่ได้รับวัคซีน">
                                                            <div class="form-control-position">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="position-relative has-icon-left">
                                                        <select class="form-control select2-l-1"
                                                            name="name_vaccine_id_2" id="basicSelect">
                                                            <option value=""> --- กรุณาเลือก ---</option>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="position-relative has-icon-left">
                                                        <input type="date" class="form-control pickadate picker__input"
                                                            readonly="" id="P428173107" aria-haspopup="true"
                                                            aria-readonly="false" aria-owns="P428173107_root"
                                                            placeholder="วันที่ได้รับวัคซีน" name="date_vaccine_2">
                                                        <div class="form-control-position">
                                                            <i class="fa fa-calendar-check-o"></i>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text" id="Vaccine" class="form-control"
                                                            name="location_vaccine_2" placeholder="สถานที่ได้รับวัคซีน">
                                                        <div class="form-control-position">
                                                            <i class="fa fa-building-o"></i>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="position-relative has-icon-left">
                                                        <select class="form-control select2-l-1"
                                                            name="name_vaccine_id_3" id="basicSelect">
                                                            <option value=""> --- กรุณาเลือก ---</option>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="position-relative has-icon-left">
                                                        <input type="date" class="form-control pickadate picker__input"
                                                            readonly="" id="P428173107" aria-haspopup="true"
                                                            aria-readonly="false" aria-owns="P428173107_root"
                                                            placeholder="วันที่ได้รับวัคซีน" name="date_vaccine_3">
                                                        <div class="form-control-position">
                                                            <i class="fa fa-calendar-check-o"></i>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text" id="Vaccine" class="form-control"
                                                            name="location_vaccine_3" placeholder="สถานที่ได้รับวัคซีน">
                                                        <div class="form-control-position">
                                                            <i class="fa fa-building-o"></i>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="position-relative has-icon-left">
                                                            <select class="form-control select2-l-1"
                                                                name="name_vaccine_id_4" id="basicSelect">
                                                                <option value=""> --- กรุณาเลือก ---</option>
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="position-relative has-icon-left">
                                                            <input type="date"
                                                                ...
                                                                id="P428173107" aria-haspopup="true"
                                                                aria-readonly="false" aria-owns="P428173107_root"
                                                                placeholder="วันที่ได้รับวัคซีน" name="date_vaccine_4">
                                                            <div class="form-control-position">
                                                                <i class="fa fa-calendar-check-o"></i>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="position-relative has-icon-left">
                                                            <input type="text" id="Vaccine" class="form-control"
                                                                name="location_vaccine_4"
                                                                placeholder="สถานที่ได้รับวัคซีน">
                                                            <div class="form-control-position">
                                                                <i class="fa fa-building-o"></i>
                                                            </div>
                                                        </div>
