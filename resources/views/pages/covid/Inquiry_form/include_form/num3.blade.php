...
<fieldset>
    ...
    <div class="form-group row">
        <h5 class="col-md-8 label-control" for="birthdate">1. ช่วง 14 วันก่อนป่วยอาศัยอยู่หรือเดินทางมาจากพื้นที่
            ที่มีการระบาด</h5>
        <div class="col-md-4">
            <li class="d-inline-block mr-2">
                <fieldset>
                    <div class="vs-radio-con">
                        <input type="radio" name="num1" value="0" checked onclick="show1();">
                        <span class="vs-radio">
            ...
            <div id="hidden_num1" style="display:none;">
                <h5 class="" for="birthdate">ระบุเมือง</h5>
                ...
                <br />
                <h5 class="" for="birthdate">ประเทศ</h5>
                ...
                <h5 class="" for="birthdate">เดินทางเข้าประเทศไทยวันที่</h5>

                <div class="position-relative has-icon-left">
                    <input type="text" id="first-name-icon" class="form-control" name="num1_date"
                        placeholder="ประเทศ">
                    <div class="form-control-position">
                ...
                <h5 class="" for="birthdate">โดยสายการบิน</h5>
                ...
                <h5 class="" for="birthdate">เที่ยวบินที่</h5>
                ...
                <h5 class="" for="birthdate">เลขที่นั่ง</h5>
        ...
        <h5 class="col-md-8 label-control" for="birthdate">2. ช่วง 14
            วันก่อนป่วยได้เข้ารับการรักษาหรือเยี่ยมผู้ป่วยในโรงพยาบาลของพื้นที่ที่มีการระบาด</h5>
        <div class="col-md-4">
            <li class="d-inline-block mr-2">
                <fieldset>
                    <div class="vs-radio-con">
                        <input type="radio" name="num2" checked value="0">
                        <span class="vs-radio">
                            <span class="vs-radio--border"></span>
                            <span class="vs-radio--circle"></span>
                        </span>
        ...
        <h5 class="col-md-8 label-control" for="birthdate">3. ช่วง 14
            วันก่อนป่วยได้ดูแลหรือสัมผัสกับผู้ป่วยอาการคล้ายไข้หวัดใหญ่หรือปอดอักเสบ</h5>
        <div class="col-md-4">
            <li class="d-inline-block mr-2">
                <fieldset>
                    <div class="vs-radio-con">
                        <input type="radio" name="num3" checked value="0">
                        <span class="vs-radio">
                            <span class="vs-radio--border"></span>
                            <span class="vs-radio--circle"></span>
                        </span>
        ...
        <h5 class="col-md-8 label-control" for="birthdate">4. ช่วง 14
        ...
        <div class="col-md-4">
            ...
            <li class="d-inline-block mr-2">
                <fieldset>
                    <div class="vs-radio-con">
                        <input type="radio" name="num4" value="1" checked onclick="show4();">
                        <span class="vs-radio">
                            <span class="vs-radio--border"></span>
                            <span class="vs-radio--circle"></span>
                        </span>
            ...
            <div id="hidden_num4" style="display:none;">
                <h5 class="" for="birthdate">ระบุ</h5>
                <div class="position-relative has-icon-left">
                    <input type="text" id="first-name-icon" class="form-control" name="num4_details"
                        placeholder="ระบุ">
                    <div class="form-control-position">
        ...
        <h5 class="col-md-8 label-control" for="birthdate">5. ช่วง 14
            วันก่อนป่วยประกอบอาชีพที่สัมผัสใกล้ชิดกับนักท่องเที่ยวต่างชาติหรือแรงงานต่างชาติ</h5>
        <div class="col-md-4">
            <li class="d-inline-block mr-2">
                <fieldset>
                    <div class="vs-radio-con">
                        <input type="radio" name="num5" checked value="0">
                        <span class="vs-radio">
                            <span class="vs-radio--border"></span>
                            <span class="vs-radio--circle"></span>
                        </span>
        ...
        <h5 class="col-md-8 label-control" for="birthdate">6. ช่วง 14
        ...
        <div class="col-md-4">
            ...
            <li class="d-inline-block mr-2">
                <fieldset>
                    <div class="vs-radio-con">
                        <input type="radio" name="num6" checked value="0" onclick="show5();">
                        <span class="vs-radio">
                            <span class="vs-radio--border"></span>
                            <span class="vs-radio--circle"></span>
                        </span>
            ...
            <div id="hidden_num6" style="display:none;">
                ...
                <div class="position-relative has-icon-left">
                    <input type="text" id="first-name-icon" class="form-control" name="num6_details"
                        placeholder="ระบุ">
                    <div class="form-control-position">
                        <i class="fa fa-pencil-square-o"></i>
                    </div>
        ...
        <h5 class="col-md-8 label-control" for="birthdate">7.
            เป็นผุ้ป่วยอาการทางเดินหายใจหรือปอดอักเสบเป็นกลุ่มก้อน</h5>
        <div class="col-md-4">
            <li class="d-inline-block mr-2">
                <fieldset>
                    <div class="vs-radio-con">
                        <input type="radio" name="num7" checked value="0">
                        <span class="vs-radio">
                            <span class="vs-radio--border"></span>
                            <span class="vs-radio--circle"></span>
                        </span>
        ...
        <h5 class="col-md-8 label-control" for="birthdate">8.
            เป็นผู้ป่วยปอดอักเสบุนแรงหรือเสียชีวิตที่หาสาเหตุไม่ได้</h5>
        <div class="col-md-4">
            <li class="d-inline-block mr-2">
                <fieldset>
                    <div class="vs-radio-con">
                        <input type="radio" name="num8" checked value="0">
                        <span class="vs-radio">
                            <span class="vs-radio--border"></span>
                            <span class="vs-radio--circle"></span>
                        </span>
        ...
        <h5 class="col-md-8 label-control" for="birthdate">9.
            เป็นบุคลากรทางการแพทย์และสาธารณสุขหรือเจ้าหน้าที่ห้องปฏิบัติการ</h5>
        <div class="col-md-4">
            <li class="d-inline-block mr-2">
                <fieldset>
                    <div class="vs-radio-con">
                        <input type="radio" name="num9" checked value="0">
                        <span class="vs-radio">
                            <span class="vs-radio--border"></span>
                            <span class="vs-radio--circle"></span>
                        </span>
        ...
        <h5 class="col-md-1 label-control" for="birthdate">10. อื่นๆ</h5>
        <div class="col-md-11">
            <div class="position-relative has-icon-left">
