                                        ...
                                        <table class="table table-hover-animation table-striped zero-configuration">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">รหัสผู้ป่วย</th>
                                                    <th class="text-center">รหัสข้อมูลทั่วไป</th>
                                                    <th class="text-center">รหัสข้อมูลคลินิก</th>
                                                    <th class="text-center">รหัสข้อมูลวัคซีน</th>
                                                    <th class="text-center">รหัสประวัติความเสี่ยง</th>
                                                    <th class="text-center">รหัสรายละเอียดเหตุการณ์</th>
                                                    <th class="text-center">รหัสค้นหาผู้สัมผัส</th>
                                                    <th class="text-center">นำเข้าเมื่อ</th>
