                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form action="{{ route('Questionnaire-History-Covid-19.confirm')}}" method="POST" class="steps-validation wizard-circle">
                                            {{ csrf_field() }}
                                            {{ method_field('POST') }}
                                            <!-- Step 1 -->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control " id="firstName3" name="firstName" value="{{ old('firstName') }}" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control " id="lastName3" name="lastName" value="{{ old('lastName') }}" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control " id="home_id" name="home_id" value="{{ old('home_id') }}">
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="select2 form-control" id="select2-array" required onchange="displayDivDemo('hideValuesOnSelect', this)"
                                                                            name="training_unit_armies">

                                                                                @foreach ($agency as $roles)
                                                                                <option value="{{$roles->id}}" @if (old('training_unit_armies') == $roles->id) {{ 'selected' }} @endif>{{$roles->name}} สังกัด {{$roles->agency_army->name}}</option>
                                                                                @endforeach
                                                                                {{-- <option value="0"> อื่นๆ </option> --}}
                                                                        </select>
                                                                        <div id="hideValuesOnSelect">
                                                                            <input type="text" class="form-control mt-1" name="training_unit_armies_detail" placeholder="โปรดระบุ.." >
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <script>
                                                        ...
                                                        <div class="table-responsive border rounded px-1 mb-1">
                                                            <h6 class="border-bottom py-1 mx-1 mb-1 font-medium-2"><i class="feather icon-home mr-50 "></i>ท่านประกอบอาชีพ</h6>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" id="occ" name="occ" value="{{ old('occ') }}">
                                                                    </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type='text' name="travel" class="form-control pickadate" value="{{ old('travel') }}" required />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type='text' name="come_travel" class="form-control pickadate" value="{{ old('come_travel') }}" required />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                ...
                                                <div class="table-responsive border rounded px-1 mb-1">
                                                    <h6 class="border-bottom py-1 mx-1 mb-1 font-medium-2"><i class="feather icon-home mr-50 "></i>กิจกรรมที่ทำก่อนเดินทางกลับเข้าจังหวัด ย้อนหลังไป 14 วัน</h6>
                                                        ...
                                                        <div class="form-label-group has-icon-left">
                                                            <textarea class="form-control  mb-1" name="activ_1" id="basicTextarea1" rows="3" placeholder="รายละเอียด.." >{{ old('activ_1') }}</textarea>
                                                        ...
                                                        <div class="form-label-group has-icon-left">
                                                            <textarea class="form-control  mb-1" name="activ_2" id="basicTextarea2" rows="3" placeholder="รายละเอียด.." >{{ old('activ_2') }}</textarea>
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-repeat"></i>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="form-label-group has-icon-left">
                                                            <textarea class="form-control  mb-1" name="activ_3" id="basicTextarea3" rows="3" placeholder="รายละเอียด.." >{{ old('activ_3') }}</textarea>
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-repeat"></i>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="form-label-group has-icon-left">
                                                            <textarea class="form-control  mb-1" name="activ_4" id="basicTextarea4" rows="3" placeholder="รายละเอียด.." >{{ old('activ_4') }}</textarea>
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-repeat"></i>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="form-label-group has-icon-left">
                                                            <textarea class="form-control  mb-1" name="activ_5" id="basicTextarea5" rows="3" placeholder="รายละเอียด.." >{{ old('activ_5') }}</textarea>
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-repeat"></i>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="form-label-group has-icon-left">
                                                            <textarea class="form-control  mb-1" name="activ_6" id="basicTextarea6" rows="3" placeholder="รายละเอียด.." >{{ old('activ_6') }}</textarea>
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-repeat"></i>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="form-label-group has-icon-left">
                                                            <textarea class="form-control  mb-1" name="activ_7" id="basicTextarea7" rows="3" placeholder="รายละเอียด.." >{{ old('activ_7') }}</textarea>
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-repeat"></i>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="form-label-group has-icon-left">
                                                            <textarea class="form-control  mb-1" name="activ_8" id="basicTextarea8" rows="3" placeholder="รายละเอียด.." >{{ old('activ_8') }}</textarea>
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-repeat"></i>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="form-label-group has-icon-left">
                                                            <textarea class="form-control  mb-1" name="activ_9" id="basicTextarea9" rows="3" placeholder="รายละเอียด.." >{{ old('activ_9') }}</textarea>
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-repeat"></i>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="form-label-group has-icon-left">
                                                            <textarea class="form-control  mb-1" name="activ_10" id="basicTextarea10" rows="3" placeholder="รายละเอียด.." >{{ old('activ_10') }}</textarea>
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-repeat"></i>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="form-label-group has-icon-left">
                                                            <textarea class="form-control  mb-1" name="activ_11" id="basicTextarea11" rows="3" placeholder="รายละเอียด.." >{{ old('activ_11') }}</textarea>
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-repeat"></i>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="form-label-group has-icon-left">
                                                            <textarea class="form-control  mb-1" name="activ_12" id="basicTextarea12" rows="3" placeholder="รายละเอียด.." >{{ old('activ_12') }}</textarea>
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-repeat"></i>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="form-label-group has-icon-left">
                                                            <textarea class="form-control  mb-1" name="activ_13" id="basicTextarea13" rows="3" placeholder="รายละเอียด.." >{{ old('activ_13') }}</textarea>
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-repeat"></i>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="form-label-group has-icon-left">
                                                            <textarea class="form-control  mb-1" name="activ_14" id="basicTextarea14" rows="3" placeholder="รายละเอียด.." >{{ old('activ_14') }}</textarea>
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-repeat"></i>
                                                                </div>
                                                        </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <ul class="list-unstyled mb-0">
                                                                        <li class="d-inline-block mr-2">
                                                                            <fieldset>
                                                                                <div class="custom-control custom-radio">
                                                                                    <input type="radio" class="custom-control-input" name="sick_covid" id="sick_covid1" @if(old('sick_covid') == "1") checked @endif value="1">
                                                                        ...
                                                                        <li class="d-inline-block mr-2">
                                                                            <fieldset>
                                                                                <div class="custom-control custom-radio">
                                                                                    <input type="radio" class="custom-control-input" name="sick_covid" id="sick_covid2" @if(old('sick_covid') == "2") checked @endif value="2">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <ul class="list-unstyled mb-0">
                                                                        <li class="d-inline-block mr-2">
                                                                            <fieldset>
                                                                                <div class="vs-radio-con">
                                                                                    <input type="radio" name="his_patient_covid" value="1" @if(old('his_patient_covid') == "1") checked @endif onclick="his_patient_covid1();">
                                                                                    <span class="vs-radio">
                                                                        ...
                                                                        <li class="d-inline-block mr-2">
                                                                            <fieldset>
                                                                                <div class="vs-radio-con">
                                                                                    <input type="radio" name="his_patient_covid" value="2" @if(old('his_patient_covid') == "2") checked @endif onclick="his_patient_covid2();">
                                                                                    <span class="vs-radio">
                                                                                        <span class="vs-radio--border"></span>
                                                                                        <span class="vs-radio--circle"></span>
                                                                                    </span>
                                                                    ...
                                                                    <div id="div1" style="display:none;margin-bottom: .5rem;">
                                                                        ...
                                                                        <ul class="list-unstyled mb-0">
                                                                            <li class="d-inline-block mr-2">
                                                                                <fieldset>
                                                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                                                        <input type="checkbox" name="fa" value="1" @if(old('fa')=="1") checked @endif>
                                                                            ...
                                                                            <li class="d-inline-block mr-2">
                                                                                <fieldset>
                                                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                                                        <input type="checkbox" name="ma" value="1" @if(old('ma')=="1") checked @endif>
                                                                                        <span class="vs-checkbox">
                                                                                            <span class="vs-checkbox--check">
                                                                                                <i class="vs-icon feather icon-check"></i>
                                                                                            </span>
                                                                            ...
                                                                            <li class="d-inline-block mr-2">
                                                                                <fieldset>
                                                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                                                        <input type="checkbox" name="bro" value="1" @if(old('bro')=="1") checked @endif>
                                                                                        <span class="vs-checkbox">
                                                                                            <span class="vs-checkbox--check">
                                                                                                <i class="vs-icon feather icon-check"></i>
                                                                                            </span>
                                                                            ...
                                                                            <li class="d-inline-block mr-2">
                                                                                <fieldset>
                                                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                                                        <input type="checkbox" name="bro2" value="1" @if(old('bro2')=="1") checked @endif>
                                                                                        <span class="vs-checkbox">
                                                                                            <span class="vs-checkbox--check">
                                                                                                <i class="vs-icon feather icon-check"></i>
                                                                                            </span>
                                                                            ...
                                                                            <li class="d-inline-block mr-2">
                                                                                <fieldset>
                                                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                                                        <input type="checkbox" name="relative" value="1" @if(old('relative')=="1") checked @endif>
                                                                                        <span class="vs-checkbox">
                                                                                            <span class="vs-checkbox--check">
                                                                                                <i class="vs-icon feather icon-check"></i>
                                                                                            </span>
                                                                            ...
                                                                            <li class="d-inline-block">
                                                                                <fieldset>
                                                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                                                        <input type="checkbox" name="friend" value="1" @if(old('friend')=="1") checked @endif>
                                                                                        <span class="vs-checkbox">
                                                                                            <span class="vs-checkbox--check">
                                                                                                <i class="vs-icon feather icon-check"></i>
                                                                                            </span>
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <ul class="list-unstyled mb-0">
                                                                        <li class="d-inline-block mr-2">
                                                                            <fieldset>
                                                                                <div class="vs-radio-con">
                                                                                    <input type="radio" name="his_place_covid" value="1" @if(old('his_place_covid') == "1") checked @endif onclick="place_covid1();">
                                                                                    <span class="vs-radio">
                                                                                        <span class="vs-radio--border"></span>
                                                                                        <span class="vs-radio--circle"></span>
                                                                                    </span>
                                                                        ...
                                                                        <li class="d-inline-block mr-2">
                                                                            <fieldset>
                                                                                <div class="vs-radio-con">
                                                                                    <input type="radio" name="his_place_covid" value="2" @if(old('his_place_covid') == "2") checked @endif onclick="place_covid2();">
                                                                                    <span class="vs-radio">
                                                                                        <span class="vs-radio--border"></span>
                                                                                        <span class="vs-radio--circle"></span>
                                                                                    </span>
                                                                    ...
                                                                    <div id="div3" style="display:none;margin-bottom: .5rem;">
                                                                        ...
                                                                        <ul class="list-unstyled mb-0">
                                                                            <li class="d-inline-block mr-2">
                                                                                <fieldset>
                                                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                                                        <input type="checkbox" name="de_store" value="1" @if(old('de_store')=="1") checked @endif>
                                                                                        <span class="vs-checkbox">
                                                                                            <span class="vs-checkbox--check">
                                                                                                <i class="vs-icon feather icon-check"></i>
                                                                                            </span>
                                                                            ...
                                                                            <li class="d-inline-block mr-2">
                                                                                <fieldset>
                                                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                                                        <input type="checkbox" name="market" value="1" @if(old('market')=="1") checked @endif>
                                                                                        <span class="vs-checkbox">
                                                                                            <span class="vs-checkbox--check">
                                                                                                <i class="vs-icon feather icon-check"></i>
                                                                                            </span>
                                                                            ...
                                                                            <li class="d-inline-block mr-2">
                                                                                <fieldset>
                                                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                                                        <input type="checkbox" name="measure" value="1" @if(old('measure')=="1") checked @endif>
                                                                                        <span class="vs-checkbox">
                                                                                            <span class="vs-checkbox--check">
                                                                                                <i class="vs-icon feather icon-check"></i>
                                                                                            </span>
                                                                            ...
                                                                            <li class="d-inline-block mr-2">
                                                                                <fieldset>
                                                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                                                        <input type="checkbox" name="Stadium" value="1" @if(old('Stadium')=="1") checked @endif>
                                                                                        <span class="vs-checkbox">
                                                                                            <span class="vs-checkbox--check">
                                                                                                <i class="vs-icon feather icon-check"></i>
                                                                                            </span>
                                                                            ...
                                                                            <li class="d-inline-block mr-2">
                                                                                <fieldset>
                                                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                                                        <input type="checkbox" name="Ent_place" value="1" @if(old('Ent_place')=="1") checked @endif>
                                                                                        <span class="vs-checkbox">
                                                                                            <span class="vs-checkbox--check">
                                                                                                <i class="vs-icon feather icon-check"></i>
                                                                                            </span>
                                                                            ...
                                                                            <li class="d-inline-block">
                                                                                <fieldset>
                                                                                    ...
                                                                                    <input type="text" class="form-control" id="detail_where" name="detail_where" value="{{ old('detail_where') }}" placeholder="โปรดระบุ...">
                                                                                </fieldset>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <ul class="list-unstyled mb-0">
                                                                        <li class="d-inline-block mr-2">
                                                                            <fieldset>
                                                                                <div class="custom-control custom-radio">
                                                                                    <input type="radio" class="custom-control-input" name="his_vaccine_flu" id="his_vaccine__flu1" value="1" @if(old('his_vaccine_flu') == "1") checked @endif onclick="his_vaccine_flu1();">
                                                                        ...
                                                                        <li class="d-inline-block mr-2">
                                                                            <fieldset>
                                                                                <div class="custom-control custom-radio">
                                                                                    <input type="radio" class="custom-control-input" name="his_vaccine_flu" id="his_vaccine__flu2" value="2" @if(old('his_vaccine_flu') == "2") checked @endif onclick="his_vaccine_flu2();">
                                                                    ...
                                                                    <div id="div2" style="display:none;margin-bottom: .5rem;">
                                                                        <input type="text" class="form-control" id="detail_time" name="detail_time" value="{{ old('detail_time') }}" placeholder="ระบุช่วง...">
                                                                    </div>
                                                                </div>
                                                        </div>
                                                        <div class="table-responsive border rounded px-1 mb-1">
                                                            <h6 class="border-bottom py-1 mx-1 mb-1 font-medium-2"><i class="feather icon-home mr-50 "></i>มีประวัติได้รับวัคซีนโควิด 19 ล่าสุดเมื่อใด (เข็มแรก หรือ ครบทั้งสองเข็ม)</h6>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <ul class="list-unstyled mb-0">
                                                                        <li class="d-inline-block mr-2">
                                                                            <fieldset>
                                                                                <div class="custom-control custom-radio">
                                                                                    <input type="radio" class="custom-control-input" name="vaccine_covid__19" id="vaccine_covid__191" value="1" @if(old('vaccine_covid__19') == "1") checked @endif onclick="vaccine_covid_191();">
                                                                                    <label class="custom-control-label" for="his_vaccine__flu1">เคยฉีด</label>
                                                                                </div>
                                                                        ...
                                                                        <li class="d-inline-block mr-2">
                                                                            <fieldset>
                                                                                <div class="custom-control custom-radio">
                                                                                    <input type="radio" class="custom-control-input" name="vaccine_covid__19" id="vaccine_covid__192" value="2" @if(old('vaccine_covid__19') == "2") checked @endif onclick="vaccine_covid_192();">
                                                                                    <label class="custom-control-label" for="his_vaccine__flu2">ไม่เคย</label>
                                                                                </div>
                                                                            </fieldset>
                                                                        </li>

                                                                    </ul>
                                                                    <div id="divvaccine_covid__192" style="display:none;margin-bottom: .5rem;">
                                                                        <input type="text" class="form-control" id="detail_time" name="vaccine_covid__19detail_time" value="{{ old('vaccine_covid__19detail_time') }}" placeholder="ระบุช่วง...">
                                                                    </div>
                                                                </div>
                                                        </div>
                                                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        function vaccine_covid_191(){
            document.getElementById('divvaccine_covid__192').style.display = 'block';
        }
        function vaccine_covid_192(){
            document.getElementById('divvaccine_covid__192').style.display = 'none';
        }
    </script>
