...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($item->report_check_up_main_detail_1->blood_chol <= '200') @else is-invalid @endif" disabled
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($item->report_check_up_main_detail_1->blood_tg <= '150') @else is-invalid @endif" disabled
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($item->report_check_up_main_detail_1->blood_bun >= '6' && $item->report_check_up_main_detail_1->blood_bun <= '20') @else is-invalid @endif" disabled
...
@if($item->report_check_up_main->gender == '1')
<div class="col-md-12">
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                ...
                <div class="input-group-append">
                    <span class="input-group-text">(0.51-0.95)</span>
                </div>
            </div>
        </div>
    </div>
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($item->report_check_up_main_detail_1->blood_uric >= '3.4' && $item->report_check_up_main_detail_1->blood_uric <= '7.0') @else is-invalid @endif" disabled
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($item->report_check_up_main_detail_1->blood_uric >= '2.4' && $item->report_check_up_main_detail_1->blood_uric <= '5.7') @else is-invalid @endif" disabled
                placeholder="ระดับกรดยูริค (Uric)" name="blood_uric"
                value="{{ $item->report_check_up_main_detail_1->blood_bun}}" >
                <div class="form-control-position">
                <i class="feather icon-edit-1"></i>
                ...
                <div class="input-group-append">
                    <span class="input-group-text">(2.4-5.7)</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                ...
                @if($item->report_check_up_main_detail_1->blood_ast >= '0' && $item->report_check_up_main_detail_1->blood_ast <= '50') @else is-invalid @endif"disabled placeholder="การทำงานของตับ (AST)" name="blood_ast"
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control
                @if($item->report_check_up_main_detail_1->blood_ast >= '0' && $item->report_check_up_main_detail_1->blood_ast <= '35') @else is-invalid @endif"
                disabled placeholder="การทำงานของตับ (AST)" name="blood_ast"
                value="{{ $item->report_check_up_main_detail_1->blood_ast}}" >
                <div class="form-control-position">
                <i class="feather icon-edit-1"></i>
                </div>
                <div class="input-group-append">
                    <span class="input-group-text">(0-35)</span>
                </div>
            </div>
        </div>
    </div>
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control
                @if($item->report_check_up_main_detail_1->blood_alt >= '0' && $item->report_check_up_main_detail_1->blood_alt <= '50') @else is-invalid @endif"
                disabled placeholder="การทำงานของตับ (ALT)" name="blood_alt"
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control
                @if($item->report_check_up_main_detail_1->blood_alt >= '0' && $item->report_check_up_main_detail_1->blood_alt <= '35') @else is-invalid @endif"
                disabled placeholder="การทำงานของตับ (AST)" name="blood_alt"
                value="{{ $item->report_check_up_main_detail_1->blood_alt}}" >
                <div class="form-control-position">
                <i class="feather icon-edit-1"></i>
                </div>
...
{{-- <div class="col-md-12">
    <div class="form-group row">
        <label class="col-md-3 label-control" for="blood_alt">การทำงานของตับ (ALP)</label>
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control @if($item->report_check_up_main_detail_1->blood_alt >= '0' && $item->report_check_up_main_detail_1->blood_alt <= '50') @else is-invalid @endif" disabled
...
<div class="col-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control" placeholder="HDL-C (mg/dl)" name="blood_hdl" disabled
...
<div class="col-12">
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <div class="position-relative has-icon-left input-group controls">
                <input type="text" id="name" class="form-control" placeholder="LDL-C (mg/dl)" name="blood_ldl" disabled
