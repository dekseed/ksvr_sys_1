...
@section('content')
  <div class="app-content content">
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h1 class="content-header-title mb-0">เพิ่มข้อมูลระบบเอกสารคุณภาพ (LAB-eDoc-Folder)</h1>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">เพิ่มข้อมูลระบบเอกสารคุณภาพ (LAB-eDoc-Folder)
                </li>
              </ol>
            </div>
          </div>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">เพิ่มข้อมูลระบบเอกสารคุณภาพ (LAB-eDoc-Folder)</h4>
    ...
    <form class="form form-horizontal" action="{{route('LAB-Upload.store')}}" method="POST" enctype="multipart/form-data"  multiple>
      {{method_field('POST')}}
      {{csrf_field()}}
      <div class="form-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-9">
            <div class="position-relative has-icon-left">
              <input type="text" id="name" class="form-control" placeholder="ชื่อเอกสาร"
              name="name" required>
