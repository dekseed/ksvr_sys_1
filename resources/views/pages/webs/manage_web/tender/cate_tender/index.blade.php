  ...
  <div class="app-content content">
    <div class="content-wrapper">
      ...
      <div class="content-header row">
        ...
        <h1 class="content-header-title mb-0">หมวดหมู่ - ประกาศจัดซื้อจัดจ้าง</h1>
                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td style="width: 10%;">
                                <form id="delete" action="{{ route('cate-tender.destroy', $cate_tender->id)}}"
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    ...
                    <form class="form" action="{{route('cate-tender.store')}}" method="POST">
                      {{csrf_field()}}
                    <div class="form-body">
                      ...
                      <div class="form-group col-12 mb-2">
                          ...
                          <div class="form-actions right">
                            <a href="{{route('tender.index')}}" class="btn btn-outline-warning mr-1"><i class="fa fa-arrow-circle-left m-r-10"></i> กลับ</a>
