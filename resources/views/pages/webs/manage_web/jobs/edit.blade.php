    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h1 class="content-header-title mb-0">แก้ไขข้อมูลประกาศรับสมัครงาน</h1>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('home')}}">แผนควบคุม</a>
                </li>
                <li class="breadcrumb-item"><a href="{{route('tender.index')}}">ข้อมูลประกาศรับสมัครงาน</a>
                </li>
                <li class="breadcrumb-item active">แก้ไขข้อมูลประกาศรับสมัครงาน
                </li>
              </ol>
            </div>
          </div>
      ...
      <div class="content-body">
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">แก้ไขข้อมูลประกาศรับสมัครงาน</h4>
       ...
       <form class="form form-horizontal" id="update" action="{{ route('job.update', $tenders->id)}}" method="POST" enctype="multipart/form-data"  multiple>
           {{ csrf_field() }}
           {{ method_field('PUT') }}
           <div class="form-body">
