               ...
               <div class="col-md-8 col-lg-9 mt-4 mt-md-0">
                  <div class="container">
                     <div class="text-center mb-2  mb-md-3 mb-lg-4">
                        ...
                        <div class="service-img text-center">
							<img src="{{ asset('web') }}/medall/images/medical/registernew1.png" data-original-height="640" data-original-width="426" height="640"  width="427" class="img-fluid" alt="">
                            <p>-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</p>
                        </div>
                        ...
                        <div class="service-img text-center">
							<img src="{{ asset('web') }}/medall/images/medical/remedicalnew01.png" data-original-height="640" data-original-width="426" height="640"  width="427" class="img-fluid" alt="">
                            <p>-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</p>
                        </div>
                        ...
                        <div class="service-img text-center">
							<img src="{{ asset('web') }}/medall/images/medical/remedicalnew02.png" data-original-height="640" data-original-width="426" height="640"  width="427" class="img-fluid" alt="">
                            <p>-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</p>
                        </div>
					</div>
				</div>
