                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-body">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <div class="position-relative has-icon-left controls">
                                                                            ...
                                                                            value="{{ $result->first_name }}" data-validation-required-message="กรุณากรอกข้อมูลช่องนี้" required>
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <div class="position-relative has-icon-left controls">
                                                                            <input type="text" id="last_name" class="form-control" placeholder="นามสกุล" name="last_name"
                                                                                value="{{$result->last_name }}" data-validation-required-message="กรุณากรอกข้อมูลช่องนี้"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <div class="position-relative has-icon-left controls">
                                                                            <input type="text" id="hn" class="form-control border-primary optional-hn" value="{{ $result->hn }}"
                                                                ...
                                                                <div class="col-md-9">
                                                                    ...
                                                                    <select class="form-control select2" name="kind_check_up" required>
                                                                        ...
                                                                        @foreach ($kind_check_up_ as $roles)
                                                                            <option {{ $roles->id == $result->kind_check_up_id ? 'selected' : '' }} value="{{$roles->id}}" >{{$roles->name}}</option>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div class="position-relative has-icon-left controls">
                                                                        ...
                                                                        value="{{ $result->department }}" data-validation-required-message="กรุณากรอกข้อมูลช่องนี้" required
                                                                        aria-invalid="false">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div class="position-relative has-icon-left controls">
                                                                        ...
                                                                        value="{{ $result->srg }}" data-validation-required-message="กรุณากรอกข้อมูลช่องนี้"
                                                                        aria-invalid="false">
                                                                        <div class="form-control-position">
                                                                            <i class="feather icon-user"></i>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-9">
                                                                    <fieldset>
                                                                        <input type="radio" name="job_description" value="งานเบา"
                                                                            @if($result->job_description ==  "งานเบา") checked="checked" @endif >
                                                                    ...
                                                                    <fieldset>
                                                                        <input type="radio" name="job_description" value="งานปานกลาง"
                                                                            @if($result->job_description ==  "งานปานกลาง") checked="checked" @endif >
                                                                    ...
                                                                    <fieldset>
                                                                        <input type="radio" name="job_description" value="งานหนัก"
                                                                            @if($result->job_description ==  "งานหนัก") checked="checked" @endif >
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div class="position-relative has-icon-left controls">
                                                                        ...
                                                                        value="{{ $result->phonenumber }}" data-validation-required-message="กรุณากรอกข้อมูลช่องนี้"
                                                                        aria-invalid="false">
                                                                        <div class="form-control-position">
