                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                                        ...
                                        <div class="form-body">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="form-group col-md-2 mb-2">
                                              ...
                                              <input type="text" id="projectinput1" class="form-control" value="{{ $report1_2->report->title_name }}"
                                              name="fname" disabled>
                                            </div>
                                            <div class="form-group col-md-5 mb-2">
                                              <label for="projectinput1">ชื่อหน้า</label>
                                              <input type="text" id="projectinput1" class="form-control" value="{{ $report1_2->report->first_name }}"
                                              name="fname" disabled>
                                            </div>
                                            <div class="form-group col-md-5 mb-2">
                                              <label for="projectinput2">นามสกุล</label>
                                              <input type="text" id="projectinput2" class="form-control" value="{{ $report1_2->report->last_name }}"
                                              name="lname" disabled>
                                            </div>
                                          </div>
                                          <div class="row">
                                            <div class="form-group col-md-7 mb-2">
                                              ...
                                              <input type="text" id="projectinput3" class="form-control" value="{{ $report1_2->report->cid }}" name="cid" disabled>
                                            </div>
                                            <div class="form-group col-md-5 mb-2">
                                              <label for="projectinput4">อายุ</label>
                                              <input type="text" id="projectinput4" class="form-control" value="{{ $report1_2->report->age }}" name="cid" disabled>
                                            </div>
                                          </div>
                                            ...
                                            <div class="col-md-12">
                                              <div class="card-text">
                                                <div class="row">
                                                  @if($report1_2->a1 ==  "1")
                                                    <div class="form-group col-md-7 mb-2">
                                                      <label for="projectinput3">ปกติ</label>
                                                    </div>
                                                   @else
                                                  <div class="form-group col-md-7 mb-2">
                                                      <label for="projectinput3">ผิดปกติ</label>
                                                    </div>
                                                  <div class="form-group col-md-7 mb-2">
                                                    <label for="projectinput3">(ระบุ)</label>
                                                    <input type="text" id="projectinput3" class="form-control" value="{{ $report1_2->a1_d }}" name="a1_d" disabled>
                                                  </div>
                                              ...
                                              <div class="card-text">
                                                <div class="input-group controls col-6">
                                                  ...
                                                  <input type="text" class="form-control"
                                                    name="name" id='name' value="{{ $report1_2->name }}" disabled>
                                      ...
                                      <div class="modal-footer mt-3">
                                        <a href="{{ route('doctor.index') }}" class="btn grey btn-outline-secondary">กลับ</a>
                                      </div>
                    </div>
                  </div>
                </div>
