                                        ...
                                        <div class="form-body">
                                          ...
                                          <div class="row">
                                            <div class="form-group col-md-2 mb-2">
                                              ...
                                              <input type="text" id="projectinput1" class="form-control" value="{{ $report1_1->report->title_name }}"
                                              name="fname" disabled>
                                            </div>
                                          ...
                                          <div class="row">
                                             <div class="form-group col-md-4 mb-2">
                                              ...
                                              <input type="text" id="projectinput3" class="form-control" value="{{ $report1_1->report->cid }}" name="cid" disabled>
                                            </div>
                                            <div class="form-group col-md-4 mb-2">
                                              <label for="projectinput3">เลขที่ HN</label>
                                              <input type="text" id="projectinput3" class="form-control" value="{{ $report1_1->report->hn }}" name="hn" disabled>
                                            </div>
                                            <div class="form-group col-md-4 mb-2">
                                              <label for="projectinput4">อายุ</label>
                                              <input type="text" id="projectinput4" class="form-control" value="{{ $report1_1->report->age }}" name="age" disabled>
                                            </div>
                                          </div>
                            ...
                            <div class="form-group col-md-6 mb-2">
                                ...
                                <div class="col-md-9">
                                        <fieldset class="ml-1">
                                          ...
                                          @if($report1_1->x_ray == "0") checked="checked" @endif disabled>
                                            <label for="input-radio-11">ไม่ได้ตรวจ</label>
                                        </fieldset>
                                        <fieldset class="ml-1">
                                          <input type="radio" name="x_ray" value="1" 
                                          @if($report1_1->x_ray == "1") checked="checked" @endif disabled>
                                          <label for="input-radio-12">ปกติ</label>
                                        </fieldset>
                                        <fieldset class="ml-1">
                                          <input type="radio" name="x_ray" value="2"
                                          @if($report1_1->x_ray == "2") checked="checked" @endif disabled>
                            ...
                            <div class="form-group col-md-6 mb-2">
                                ...
                                <div class="col-md-9">
                                        <fieldset class="ml-1">
                                          ...
                                          @if($report1_1->urine == "0") checked="checked" @endif disabled>
                                            <label for="input-radio-11">ไม่ได้ตรวจ</label>
                                        </fieldset>
                                        <fieldset class="ml-1">
                                          <input type="radio" name="urine" value="1" onclick="urine2();"
                                          @if($report1_1->urine == "1") checked="checked" @endif disabled>
                                          <label for="input-radio-12">ปกติ</label>
                                        </fieldset>
                                        <fieldset class="ml-1">
                                          <input type="radio" name="urine" value="2" onclick="urine1();"
                                          @if($report1_1->urine == "2") checked="checked" @endif disabled>
                                          <label for="input-radio-12">ผิดปกติ</label>
                                                 ...
                                                 <div class="form-group col-12 mb-2">
                                                    ...
                                                    <div class="input-group">
                                                      <fieldset class="ml-1">
                                                        ...
                                                        @if($report1_1->urine_d1 == "0") checked="checked" @endif disabled>
                                                          <label for="input-radio-11">ไม่มี</label>
                                                      </fieldset>
                                                      <fieldset class="ml-1">
                                                        <input type="radio" name="urine_d1" value="1"
                                                        @if($report1_1->urine_d1 == "1") checked="checked" @endif disabled>
                                                      ...
                                                      <div class="input-group">
                                                        <fieldset class="ml-1">
                                                          ...
                                                          @if($report1_1->urine_d2 == "0") checked="checked" @endif disabled>
                                                            <label for="input-radio-11">ไม่มี</label>
                                                        </fieldset>
                                                        <fieldset class="ml-1">
                                                          <input type="radio" name="urine_d2" value="1"
                                                          @if($report1_1->urine_d2 == "1") checked="checked" @endif disabled>
                                                          <label for="input-radio-12">มี</label>
                                                        </fieldset>
                                                    ...
                                                    <fieldset>
                                                        <div class="input-group controls">
                                                          ...
                                                          name="urine_d" id='urine_d' value="{{ $report1_1->urine_d }}" disabled>
                            ...
                            <div class="form-group col-md-6 mb-2">
                              ...
                              <div class="col-md-9">
                                <fieldset class="ml-1">
                                  ...
                                  @if($report1_1->cbc == "0") checked="checked" @endif disabled>
                                  <label for="input-radio-11">ไม่ได้ตรวจ</label>
                                  </fieldset>
                                        <fieldset class="ml-1">           
                                  <input type="radio" name="cbc" value="1" onclick="CBC2();"
                                  @if($report1_1->cbc == "1") checked="checked" @endif disabled>
                                  <label for="input-radio-12">ปกติ</label>
                                     </fieldset>
                                        <fieldset class="ml-1">         
                                  <input type="radio" name="cbc" value="2" onclick="CBC2();"
                                  @if($report1_1->cbc == "2") checked="checked" @endif disabled>
                                  <label for="input-radio-12">ผิดปกติ Hct < 40% และ Mcv < 78%</label>
                                        </fieldset>
                                        <fieldset class="ml-1">  
                                                <input type="radio" name="cbc" value="3" onclick="CBC1();"
                                                @if($report1_1->cbc == "3") checked="checked" @endif disabled>
                                                    ...
                                                    <div class="col-md-12">
                                                      <fieldset>
                                                        <div class="input-group controls">
                                                          <span class="input-group-addon">(ระบุ)</span>
                                                          <input type="text" class="form-control" aria-label="" placeholder=""
                                                          name="cbc_d" id='cbc_d' value="{{ $report1_1->cbc_d }}" disabled>
                            ...
                            <div class="form-group col-md-6 mb-2">
                                            ...
                                            <div class="col-md-9">
                                              <fieldset class="ml-1">
                                                ...
                                                @if($report1_1->pap == "0") checked="checked" @endif disabled>
                                                  <label for="input-radio-11">ไม่ได้ตรวจ</label>
                                             </fieldset>
                                             <fieldset class="ml-1">  
                                                <input type="radio" name="pap" value="1"  onclick="j10_2_2();"
                                                @if($report1_1->pap == "1") checked="checked" @endif disabled>
                                                <label for="input-radio-12">ปกติ</label>
                                              </fieldset>
                                              <fieldset class="ml-1">  
                                                <input type="radio" name="pap" value="2" onclick="j10_2_1();"
                                                @if($report1_1->pap == "2") checked="checked" @endif disabled>
                                                <label for="input-radio-12">ผิดปกติ</label>
                                                    ...
                                                    <div class="col-md-12">
                                                      <fieldset>
                                                        <div class="input-group controls">
                                                          <span class="input-group-addon">(ระบุ)</span>
                                                          <input type="text" class="form-control" aria-label="" placeholder=""
                                                          name="pap_d" id='pap_d' value="{{ $report1_1->pap_d }}" disabled>
                                    ...
                                    <hr>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                              <div class="position-relative has-icon-left controls">
                                                ...
                                                value="{{ $report1_1->blood_glu }}" data-validation-required-message="กรุณากรอกข้อมูลช่องนี้" disabled>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                              <div class="position-relative has-icon-left controls">
                                                ...
                                                value="{{ $report1_1->blood_chol }}" data-validation-required-message="กรุณากรอกข้อมูลช่องนี้" disabled>
                                                <div class="form-control-position">
                                                  <i class="ft-user"></i>
                                                </div>
                                              </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                              <div class="position-relative has-icon-left controls">
                                                ...
                                                value="{{ $report1_1->blood_tg }}" data-validation-required-message="กรุณากรอกข้อมูลช่องนี้" disabled>
                                                <div class="form-control-position">
                                                  <i class="ft-user"></i>
                                                </div>
                                              </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                              <div class="position-relative has-icon-left controls">
                                                ...
                                                value="{{ $report1_1->blood_hdl }}" data-validation-required-message="กรุณากรอกข้อมูลช่องนี้" disabled>
                                                <div class="form-control-position">
                                                  <i class="ft-user"></i>
                                                </div>
                                              </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                              <div class="position-relative has-icon-left controls">
                                                ...
                                                value="{{ $report1_1->blood_ldl }}" data-validation-required-message="กรุณากรอกข้อมูลช่องนี้" disabled>
                                                <div class="form-control-position">
                                                  <i class="ft-user"></i>
                                                </div>
                                              </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                              <div class="position-relative has-icon-left controls">
                                                ...
                                                value="{{ $report1_1->blood_bun }}" data-validation-required-message="กรุณากรอกข้อมูลช่องนี้" disabled>
                                                <div class="form-control-position">
                                                  <i class="ft-user"></i>
                                                </div>
                                              </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                              <div class="position-relative has-icon-left controls">
                                                ...
                                                value="{{ $report1_1->blood_cr }}" data-validation-required-message="กรุณากรอกข้อมูลช่องนี้" disabled>
                                                <div class="form-control-position">
                                                  <i class="ft-user"></i>
                                                </div>
                                              </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                              <div class="position-relative has-icon-left controls">
                                                ...
                                                value="{{ $report1_1->blood_uric }}" data-validation-required-message="กรุณากรอกข้อมูลช่องนี้" disabled>
                                                <div class="form-control-position">
                                                  <i class="ft-user"></i>
                                                </div>
                                              </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                              <div class="position-relative has-icon-left controls">
                                                ...
                                                value="{{ $report1_1->blood_ast }}" data-validation-required-message="กรุณากรอกข้อมูลช่องนี้" disabled>
                                                <div class="form-control-position">
                                                  <i class="ft-user"></i>
                                                </div>
                                              </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                              <div class="position-relative has-icon-left controls">
                                                ...
                                                value="{{ $report1_1->blood_alt }}" data-validation-required-message="กรุณากรอกข้อมูลช่องนี้" disabled>
                                                <div class="form-control-position">
                                                  <i class="ft-user"></i>
                                                </div>
                                              </div>
                                      ...
                                      <a href="{{ route('staff.index') }}" class="btn grey btn-outline-secondary">กลับ</a>
                                      <a href="{{ route('staff.edit', $report1_1->report1_id) }}" class="btn btn-primary">แก้ไข</a>
                                  </div>
                                    </div>
                                  </div>
                </div>
