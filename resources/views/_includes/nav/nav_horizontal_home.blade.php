        ...
        <div class="navbar-container content">
            <div class="navbar-collapse" id="navbar-mobile">
                <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                    ...
                    <ul class="nav navbar-nav bookmark-icons">
                            ...
                            @if (Auth::user()->hasRole(['superadministrator', 'administrator', 'schedule-stock']))
                                <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('dashboard_stock') }}" data-toggle="tooltip" data-placement="top" title="ระบบบันทึกข้อมูลครุภัณฑ์"><i class="ficon feather icon-package"></i></a></li>
                            @endif
                                <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('repair.index') }}" data-toggle="tooltip" data-placement="top" title="ระบบแจ้งซ่อมอุปกรณ์"><i class="ficon feather icon-monitor"></i></a></li>

                                {{-- <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('borrow.index') }}" data-toggle="tooltip" data-placement="top" title="ระบบยืม/คืน อุปกรณ์คอมพิวเตอร์"><i class="ficon feather icon-book"></i></a></li> --}}
                            @if (Auth::user()->hasRole(['superadministrator', 'administrator', 'Community_Health_Center']))
                                <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('check_up.index') }}" data-toggle="tooltip" data-placement="top" title="Covid-19"><i class="ficon feather icon-activity"></i></a></li>
                            @endif
                    </ul>
                    <ul class="nav navbar-nav">
                        <li class="nav-item d-none d-lg-block"><a class="nav-link bookmark-star"><i class="ficon feather icon-star warning"></i></a>
                            <div class="bookmark-input search-input">
                                ...
                                <input class="form-control input" type="text" placeholder="ค้นหา..." tabindex="0" data-search="template-list">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    @if(\Auth::check())
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{Auth::user()->title_name->name}}{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="{{ route('profile.show1') }}"><i class="feather icon-user"></i> ข้อมูลส่วนตัว</a>
